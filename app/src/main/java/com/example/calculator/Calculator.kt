...
fun Calculator(
    ...
    Box(modifier = modifier) {
        Column(
            ...
            Text(
                text = state.num1 + (state.operator?.symbol ?: "") + state.num2,
            ...
            Row(
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .weight(1f),
                    onClick = {
                        onAction(CalcAction.Operation(CalcOperation.Div))
                    }
                )
            }
            ...
            Row(
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .weight(1f),
                    onClick = {
                        onAction(CalcAction.Operation(CalcOperation.Mul))
                    }
                )
            }
            Row(
                ...
                CalculatorButton(
                    ...
                    modifier = Modifier
                        ...
                        .weight(1f),
                    onClick = {
                        onAction(CalcAction.Operation(CalcOperation.Sub))
                    }
                )
            }
            Row(
